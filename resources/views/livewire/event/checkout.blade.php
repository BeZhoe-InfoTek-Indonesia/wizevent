<div class="bg-[#F8FAFC] min-h-screen font-sans text-slate-900 pb-24">
    ...
    <div class="relative w-full h-[200px] md:h-[300px] bg-slate-900 overflow-hidden">
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-6">
            ...
            <div class="flex flex-wrap justify-center items-center gap-4 text-xs md:text-sm font-bold uppercase tracking-widest text-blue-400">
            ...
            <div class="flex items-center justify-center">
                <div class="flex items-center w-full max-w-3xl">
                    ...
                    <div class="flex flex-col items-center flex-1 relative">
                        <div class="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white mb-2 z-10 shadow-lg shadow-blue-600/30 ring-4 ring-blue-50">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg>
                        </div>
                        <span class="text-[10px] font-black uppercase tracking-widest text-blue-600">1. Select</span>
                    </div>
                    <!-- Line -->
                    <div class="flex-1 h-0.5 bg-blue-600 mx-2 -mt-6 rounded-full opacity-50"></div>
                    <!-- Step 2: Review -->
                    <div class="flex flex-col items-center flex-1 relative">
                        <div class="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white mb-2 z-10">
                            <span class="text-base font-black italic">2</span>
                        </div>
                        <span class="text-[10px] font-black uppercase tracking-widest text-slate-800">2. Review</span>
                    </div>
                    <!-- Line -->
                    ...
                    <div class="flex flex-col items-center flex-1 relative opacity-30">
                        ...
                        <span class="text-[10px] font-black uppercase tracking-widest text-slate-400">3. Payment</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 max-w-5xl mt-8">
        ...
        <nav class="flex text-slate-400 font-bold text-[9px] uppercase tracking-[0.2em] space-x-3 mb-6" aria-label="Breadcrumb">
            ...
            <span>/</span>
            <a href="#" class="hover:text-blue-600 transition-colors">Concerts</a>
            <span>/</span>
        ...
        <div class="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div class="flex-1 w-full space-y-6">
                @foreach($event->ticketTypes as $ticketType)
                    <div class="group bg-white rounded-2xl border border-slate-200 overflow-visible hover:border-blue-400 transition-all duration-300 shadow-sm hover:shadow-lg relative">
                        ...
                        <div wire:loading.flex wire:target="incrementQuantity({{ $ticketType->id }}), decrementQuantity({{ $ticketType->id }})" class="absolute inset-0 bg-white/60 backdrop-blur-[1px] z-20 items-center justify-center rounded-2xl">
                            <div class="flex flex-col items-center gap-2">
                                ...
                                <span class="text-[10px] font-black text-blue-600 uppercase tracking-widest">Pricing...</span>
                            </div>
                        </div>
                        ...
                        <div class="p-6 md:p-8">
                            <div class="flex justify-between items-start mb-4">
                                <h4 class="text-xl md:text-2xl font-black text-slate-900 group-hover:text-blue-600 transition-colors uppercase tracking-tight">
                                    {{ $ticketType->name }}
                                </h4>
                            ...
                            <ul class="space-y-4 mb-8">
                                <li class="flex items-center gap-4">
                                    <div class="w-7 h-2 rounded-lg bg-blue-50 flex items-center justify-center text-blue-600 shrink-0">
                            ...
                            <div class="inline-flex items-center gap-2 px-4 py-2 bg-blue-50/50 rounded-xl border border-blue-100">
                                <span class="animate-pulse w-1.5 h-1.5 rounded-full bg-blue-600"></span>
                        ...
                        {{-- Foot --}}
                        <div class="p-6 md:p-8 flex flex-row justify-between items-center">
                            <div>
                            ...
                            <div class="flex items-center bg-white border border-slate-100 rounded-xl p-1 gap-4 shadow-sm">
                                <button 
                                ...
                                <button 
                                    ...
                                    class="w-9 h-9 flex items-center justify-center rounded-lg bg-blue-600 text-white hover:bg-blue-700 shadow-md shadow-blue-600/20 transition-all disabled:opacity-30"
                                    ...
                                    @if(($quantities[$ticketType->id] ?? 0) > 0)
                                        <div class="flex items-center gap-4 p-3 bg-slate-50/50 rounded-xl border border-slate-100">
                                            <div class="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center text-blue-600 shadow-inner">
                                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24 text-blue-600">
                            ...
                            <div class="pt-6 border-t-2 border-dashed border-slate-50 space-y-4">
                                ...
                                <div class="pt-4 space-y-5">
                                    ...
                                    <button 
                                        ...
                                        class="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-black text-base uppercase tracking-widest rounded-2xl shadow-xl shadow-blue-600/30 transition-all transform hover:-translate-y-0.5 active:scale-[0.98] flex items-center justify-center gap-3 group"
                                    >
                                        <span>Order Now</span>
                    ...
                    @else
                        ...
                        <div class="text-center py-16 flex flex-col items-center justify-center">
                            <div class="w-24 h-24 bg-slate-50 rounded-[32px] flex items-center justify-center mb-6 shadow-inner group">
                                <svg class="w-12 h-12 text-slate-200 group-hover:text-blue-100 transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
