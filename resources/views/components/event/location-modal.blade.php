...
<div x-data="{ show: @entangle('showLocationModal') }">
    <template x-teleport="body">
        <div x-show="show" 
                ...
                class="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm transition-opacity" 
                wire:click.self="toggleLocationModal">
            
            <div class="bg-white rounded-[2rem] w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col shadow-2xl animate-in zoom-in duration-200">
                <!-- Header -->
